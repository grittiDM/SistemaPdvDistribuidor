 ...
 */
package br.pdvcongelados.view.venda;
...
public class InfoVenda extends javax.swing.JDialog {

    private Venda venda;

    public InfoVenda(java.awt.Frame parent, boolean modal, Venda venda) {
        super(parent, modal);
        initComponents();
        this.venda = venda;
        
        Utils.updateTable(venda.getItems(), vendaItemsTable);
        txtCode.setText(venda.getId().toString());
        txtCustomer.setText(venda.getNomeCliente());
        txtCustomerCpf.setText(venda.getCpfCliente());
        txtEmployee.setText(venda.getNomeUsuario());
        txtTotal.setText(String.format("R$ %.2f", venda.getValorTotal()));
        txtMoment.setValue(venda.getMoment());
        txtInstallments.setText(venda.getInstallments().toString());
        txtPayment.setText(venda.getTipoPagamento());
    }
    ...
    private void initComponents() {
        ...
        vendaItemsTable = new javax.swing.JTable();
        ...
        vendaItemsTable.setBackground(new java.awt.Color(255, 255, 255));
        vendaItemsTable.setForeground(new java.awt.Color(0, 0, 0));
        vendaItemsTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        vendaItemsTable.setGridColor(new java.awt.Color(204, 204, 204));
        vendaItemsTable.setSelectionBackground(new java.awt.Color(51, 51, 51));
        jScrollPane1.setViewportView(vendaItemsTable);
        if (vendaItemsTable.getColumnModel().getColumnCount() > 0) {
            vendaItemsTable.getColumnModel().getColumn(0).setMinWidth(50);
            vendaItemsTable.getColumnModel().getColumn(0).setPreferredWidth(80);
            vendaItemsTable.getColumnModel().getColumn(0).setMaxWidth(150);
            vendaItemsTable.getColumnModel().getColumn(3).setMinWidth(50);
            vendaItemsTable.getColumnModel().getColumn(3).setPreferredWidth(80);
            vendaItemsTable.getColumnModel().getColumn(3).setMaxWidth(120);
            vendaItemsTable.getColumnModel().getColumn(4).setMinWidth(50);
            vendaItemsTable.getColumnModel().getColumn(4).setPreferredWidth(120);
            vendaItemsTable.getColumnModel().getColumn(4).setMaxWidth(150);
            vendaItemsTable.getColumnModel().getColumn(5).setMinWidth(50);
            vendaItemsTable.getColumnModel().getColumn(5).setPreferredWidth(80);
            vendaItemsTable.getColumnModel().getColumn(5).setMaxWidth(150);
            vendaItemsTable.getColumnModel().getColumn(6).setMinWidth(50);
            vendaItemsTable.getColumnModel().getColumn(6).setPreferredWidth(80);
            vendaItemsTable.getColumnModel().getColumn(6).setMaxWidth(150);
            vendaItemsTable.getColumnModel().getColumn(7).setMinWidth(60);
            vendaItemsTable.getColumnModel().getColumn(7).setPreferredWidth(100);
            vendaItemsTable.getColumnModel().getColumn(7).setMaxWidth(150);
        }
    ...
    private javax.swing.JTable vendaItemsTable;
