...
public class Pagamento extends javax.swing.JFrame {
     ...
     */
    public Pagamento(NovaVenda janelVenda) {
        initComponents();
        this.setBackground(new Color(0,0,0,0));
        jPanel1.setBackground(new Color(0,0,0,0));
        
        this.janelVenda = janelVenda;
    }

    public NovaVenda getSaleWindow() {
        return janelVenda;
    }
    ...
    private void btMoneyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btMoneyActionPerformed
        janelVenda.getSale().setPayment(Venda.DINHEIRO);
        
        this.dispose();
        new PagamentoDinheiro(this, true).setVisible(true);
    ...
    private void btDebitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btDebitActionPerformed
        janelVenda.getSale().setPayment(Venda.DEBITO);
        
        this.dispose();
        new PagamentoDebito(this, true).setVisible(true);
    ...
    private void btCreditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCreditActionPerformed
        janelVenda.getSale().setPayment(Venda.CREDITO);
        
        this.dispose();
        new PagamentoCredito(this, true).setVisible(true);
    ...
    private void btCreditAndMoneyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCreditAndMoneyActionPerformed
        janelVenda.getSale().setPayment(Venda.DINHEIROCREDITO);
        
        this.dispose();
        new PagamentoDinheiroCredito(this, true).setVisible(true);
