...
public class PagamentoCredito extends javax.swing.JDialog {

    private Venda venda;
    private NovaVenda janelaVenda;

    public PagamentoCredito(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setBackground(new Color(0,0,0,0));
        jPanel1.setBackground(new Color(0,0,0,0));
        janelaVenda = ((Pagamento)parent).getJanelaVenda();
        Venda venda = janelaVenda.getVenda();
        venda = janelaVenda.getVenda();
        
        txtSaleValue.setText(String.format("R$ %.2f", venda.getValorTotal()));
    }
