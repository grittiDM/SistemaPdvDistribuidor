...
public class PagamentoDinheiro extends javax.swing.JDialog {
    ...
    private Venda venda;
    private NovaVenda janelaVenda;

    public PagamentoDinheiro(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setBackground(new Color(0,0,0,0));
        jPanel1.setBackground(new Color(0,0,0,0));
        janelaVenda = ((Pagamento)parent).getJanelaVenda();
        venda = janelaVenda.getVenda();
        txtAmountReceived.requestFocusInWindow();
        
        txtVendaPrice.setText(String.format("%.2f", venda.getValorTotal()));
    ...
    private void initComponents() {
        ...
        jPanel1.add(txtVendaPrice, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 70, 120, 30));
    ...
    private void txtAmountReceivedKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtAmountReceivedKeyPressed
        if (evt.getKeyCode() == java.awt.event.KeyEvent.VK_ENTER) {
            ...
            Double change = amountReceived - venda.getValorTotal();
